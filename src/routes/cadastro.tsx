...
export const Route = createFileRoute("/cadastro")({
  head: () => ({
    meta: [
      { title: "Criar conta — Schedu" },
      { name: "description", content: "Cadastre sua escola no Schedu em segundos." },
    ],
  }),
    ...
    <div className="min-h-screen w-full bg-surface relative overflow-hidden flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-card/80 backdrop-blur border border-border rounded-2xl shadow-elevated p-6 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-bold tracking-tight mb-1">Criar conta</h2>
          <p className="text-sm text-muted-foreground mb-6">
            Comece a organizar o quadro da sua escola.
          </p>
